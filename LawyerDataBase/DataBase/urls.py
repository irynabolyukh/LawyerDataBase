...
urlpatterns = [
    ...
    path('appointment_N/create', views.App_NCreateView.as_view(), name='appointment_n-create'),
    path('appointment_J/create', views.App_JCreateView.as_view(), name='appointment_j-create'),
    path('appointment_N/<pk>/create', views.Appointment_NCreateView.as_view(), name='appointment_n-create'),
    path('appointment_N/<pk>/<dossier_code>/create', views.Appoint_NCreateView.as_view(), name='appointment_n-create'),
    path('appointment_J/<pk>/<dossier_code>/create', views.Appoint_JCreateView.as_view(), name='appointment_j-create'),
    path('appointment_J/<pk>/create', views.Appointment_JCreateView.as_view(), name='appointment_j-create'),
    ...
    path('dossier_N/create', views.Doss_NCreateView.as_view(), name='dossier_n-create'),
    path('dossier_J/create', views.Doss_JCreateView.as_view(), name='dossier_j-create'),
